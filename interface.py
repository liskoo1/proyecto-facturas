...
class body:
    ...
    def init_body(self):
        ...
        #Label(self.root,pady=1, padx=600,bg="black").grid(row=2, columnspan=2)
        #Create label
    ...
    def search_article(self, nombre_art, widget,destroy):
        ...
        try:
            ...
            Button(self.select_button,font=("Harlow Solid",12,"bold"),cursor="hand2",border=0,pady=10,bg= "#5D6D7E", text= "Actualizar articulo", command=lambda:Db().modify_article(self.data_text,self.select_button)).pack()
        except:
            pass
